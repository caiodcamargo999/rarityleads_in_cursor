                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-3 bg-[#0a0a0a]/50 backdrop-blur-sm border border-gray-800 rounded-lg focus:ring-2 focus:ring-[#8b5cf6]/50 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400"
                  ...
                  {isLogin && (
                    <div className="flex items-center justify-between">
                      <label className="flex items-center">
                        <input type="checkbox" className="rounded border-gray-800 text-[#8b5cf6] focus:ring-[#8b5cf6]/50 bg-[#0a0a0a]/50" />
                        <span className="ml-2 text-sm text-gray-400">Remember me</span>
                      </label>
                      <Link href="#" className="text-sm text-[#8b5cf6] hover:text-[#8b5cf6]/80 transition-colors">
                        Forgot password?
                      </Link>
                    </div>
                  )}
