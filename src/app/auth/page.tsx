            ...
            <CardContent className="relative z-10">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full border-border text-foreground hover:bg-muted flex items-center justify-center gap-2 bg-gradient-to-br from-muted to-muted/80 dark:from-muted/60 dark:to-muted/40 hover:from-muted/90 hover:to-muted/70 dark:hover:from-muted/70 dark:hover:to-muted/50"
                >
                  <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" style={{ display: 'block' }}>
                    <path
                      fill="currentColor"
