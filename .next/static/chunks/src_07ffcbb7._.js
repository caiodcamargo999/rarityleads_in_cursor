...
function LeadsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LeadsPage.useEffect": ()=>{
            const fetchUserAndLeads = {
                "LeadsPage.useEffect.fetchUserAndLeads": async ()=>{
                    ...
                    if (!error && data) {
                        setLeads(data.map({
                            "LeadsPage.useEffect.fetchUserAndLeads": (item)=>{
                                const obj = item;
                                return {
                                    id: String(obj.id),
                                    data: obj.data,
                        ...
                        }["LeadsPage.useEffect.fetchUserAndLeads"]));
                    }
                    setLoading(false);
                }
            }["LeadsPage.useEffect.fetchUserAndLeads"];
...
_s(LeadsPage, "6Hy59FObgCdzlX8GkYYAGPAUe7I=", false, function() {
    return [
...
//# sourceMappingURL=src_07ffcbb7._.js.map