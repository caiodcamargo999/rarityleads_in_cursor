            ...
            <CardContent className="relative z-10">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.button
                  ...
                  className="w-full border border-border bg-transparent text-foreground hover:bg-muted rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rarity-500 focus-visible:ring-offset-2 h-10 px-4 flex items-center justify-center gap-2 bg-gradient-to-br from-muted to-muted/80 dark:from-muted/60 dark:to-muted/40 hover:from-muted/90 hover:to-muted/70 dark:hover:from-muted/70 dark:hover:to-muted/50"
                  whileTap={{ scale: 0.98 }}
