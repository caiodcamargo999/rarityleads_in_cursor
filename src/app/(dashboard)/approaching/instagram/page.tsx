...
export default function InstagramPage() {
  ...
  const instagramInView = useInView(instagramRef, { once: true })
  ...
  const stats = [
    { title: "Active Conversations", value: "0", icon: Instagram },
    { title: "Messages Sent", value: "0", icon: Send },
    { title: "Response Rate", value: "0%", icon: BarChart3 },
    { title: "Connected Accounts", value: "0", icon: Users }
  ]

  return (
    <div ref={instagramRef} className="min-h-screen bg-[#0a0a0a] p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={instagramInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
        ...
        >
          ...
          <p className="text-base text-gray-400">
            Connect with prospects through Instagram DMs and stories.
          </p>
        </motion.div>
        ...
        >
          ...
          <Button variant="secondary" size="lg" className="h-20 flex flex-col items-center justify-center gap-2 text-lg font-medium">
            ...
            <span className="text-sm opacity-80">Add Instagram</span>
          </Button>
        ...
        >
          <Card className="bg-[#1a1a1a]/50 backdrop-blur-xl border border-gray-800">
            <CardHeader>
              <CardTitle className="text-2xl font-normal text-white">Instagram Conversations</CardTitle>
            ...
            <CardContent>
              {filteredConversations.length === 0 ? (
                <div className="text-center py-16">
                  <Instagram className="w-16 h-16 text-gray-600 mx-auto mb-6" />
                  ...
                  <p className="text-gray-400 mb-8 max-w-md mx-auto">
                    {searchTerm 
                      ...
                      : 'Start by creating your first Instagram campaign or connecting an account.'
                    }
                  </p>
